...
// Send auto-sync failure notification email
export async function sendAutoSyncFailureEmail(
    email: string,
    name: string,
    providerName: string,
    errorReason: string
): Promise<void> {
    const subject = `Auto-Sync Disabled for ${providerName} - NoBullFit`;
    const integrationsUrl = `${APP_URL}/dashboard/integrations`;
    ...
    const htmlBody = `
        ...
        <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #18181b;">
            <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                ...
                <div style="background-color: #ffffff; padding: 30px; border-radius: 8px;">
                    <h2 style="color: #18181b; margin-top: 0; font-size: 20px; font-weight: 600;">Auto-Sync Has Been Disabled</h2>

                    <p style="color: #18181b; margin: 16px 0;">Hi ${name},</p>

                    <p style="color: #18181b; margin: 16px 0;">
                        We wanted to let you know that automatic syncing for your <strong>${providerName}</strong> integration has been temporarily disabled due to repeated sync failures.
                    </p>

                    <div style="margin: 24px 0; padding: 16px; background-color: #fef2f2; border-left: 4px solid #ef4444; border-radius: 4px;">
                        <p style="color: #991b1b; margin: 0; font-size: 14px;">
                            <strong>What happened:</strong> ${errorReason}
                        </p>
                    </div>
                    ...
                    <ul style="color: #18181b; margin: 16px 0; padding-left: 20px;">
                        <li style="margin-bottom: 8px;">Your connection to ${providerName} has expired</li>
                        <li style="margin-bottom: 8px;">You revoked access permissions in ${providerName}</li>
                        <li style="margin-bottom: 8px;">There was a temporary issue with ${providerName}'s servers</li>
                    </ul>

                    <p style="color: #18181b; margin: 16px 0;">
                        <strong>To fix this:</strong>
                    </p>
                    <ol style="color: #18181b; margin: 16px 0; padding-left: 20px;">
                        <li style="margin-bottom: 8px;">Go to your Integrations page</li>
                        <li style="margin-bottom: 8px;">Disconnect and reconnect ${providerName}</li>
                        <li style="margin-bottom: 8px;">Re-enable auto-sync</li>
                    </ol>

                    <div style="text-align: center; margin: 30px 0;">
                        <a href="${integrationsUrl}" style="display: inline-block; background-color: #27272a; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 500;">Go to Integrations</a>
                    </div>

                    <div style="margin-top: 30px; padding: 16px; background-color: #f0f9ff; border-left: 4px solid #0ea5e9; border-radius: 4px;">
                        <p style="color: #0c4a6e; margin: 0; font-size: 14px;">
                            <strong>Note:</strong> Your data is safe. You can still manually sync at any time, and all your previously synced data remains in your account.
                        </p>
                    </div>

                    <p style="color: #18181b; margin: 16px 0;">
                        If you continue to experience issues, please don't hesitate to contact us at <a href="mailto:${FROM_EMAIL}" style="color: #27272a; text-decoration: underline;">${FROM_EMAIL}</a>.
                    </p>
    ...
    const textBody = `
Auto-Sync Disabled for ${providerName} - NoBullFit

Hi ${name},

We wanted to let you know that automatic syncing for your ${providerName} integration has been temporarily disabled due to repeated sync failures.

What happened: ${errorReason}

This usually happens when:
- Your connection to ${providerName} has expired
- You revoked access permissions in ${providerName}
- There was a temporary issue with ${providerName}'s servers

To fix this:
1. Go to your Integrations page at ${integrationsUrl}
2. Disconnect and reconnect ${providerName}
3. Re-enable auto-sync

Note: Your data is safe. You can still manually sync at any time, and all your previously synced data remains in your account.

If you continue to experience issues, please contact us at ${FROM_EMAIL}.
